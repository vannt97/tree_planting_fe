  ...
  return (
    <div>
      ...
      <Seo
        ...
        description="Từ ngày 01/11/2022 đến 31/03/2023, với mỗi sản phẩm thuộc bộ GIẢI PHÁP SỨC KHỎE TOÀN DIỆN được bán ra, Panasonic Việt Nam sẽ trồng một cây xanh phát triển rừng.
      ...
      <Script async src="https://www.googletagmanager.com/gtag/js?id=G-4HMFWRNT84" />
...
export const getServerSideProps: GetServerSideProps<HomeProps> = async (
  ...
  const response = await fetch(`${process.env.NEXT_PUBLIC_DOMAIN_API}/api/StaticPages/ImageTrial`);
