...
const MapSecondary = ({ trackingData, children }: any) => {
    ...
    if (screenWidth) {
      return (
        <div className="w-[90%] h-full mx-auto">
          {screenWidth >= 1025 && (
            <div className="">
              <p className="uppercase heading-1 text-green-primary font-bold mobile:text-center laptop:text-start">
          ...
          <div className="text-justify">
            <TreeDetailStorySecondary data={siteData} trackingData={trackingData} />
          </div>
        </div>
      );
    }
  ...
  const responsiveMap = useMemo(() => {
    if (screenWidth >= 1600) {
      ...
      return 'scale(1.1) translate(12px, 69px)';
    } else if (screenWidth >= 1300) {
      return 'scale(1.1) translate(1%, 60px)';
    } else if (screenWidth >= 1200) {
      return 'scale(1.1) translate(4px, 75px)';
      ...
      return 'scale(1.2) translate(1%, 14%)';
    }
  ...
  // relative tree-detail__map tree-detail__map-secondary laptop:px-5 flex flex-col laptop:flex-row justify-evenly pt-[0] pb-[8%] tablet:py-[4%] laptop:py-[10%]
  return (
    <div className="tree-detail w-full h-full relative " id="tree-map">
      <div className="relative tree-detail__map tree-detail__map-secondary laptop:px-5 flex flex-col laptop:flex-row justify-evenly pt-[0] pb-[8%] tablet:py-[4%] laptop:py-[10%] ">
        {screenWidth < 1025 && (
          <div className="">
            <h1 className="uppercase heading-1 text-green-primary font-bold text-center">
              danh sách <br className="bloack tablet:hidden" />
              điểm trồng cây
            </h1>
            <div className="laptop:flex tablet:flex mobile:block laptop:justify-center mobile:justify-center tablet:justify-center items-center laptop:mb-4 mobile:mb-2 flex-wrap mb-2">
        ...
        <div className="w-[100%] laptop:w-[40%] desktop:w-[40%] px-6  desktop:px-14 relative z-10">
          <div
            className=" py-10"
            style={{
        ...
        {/* <img
          className="hidden tablet:block absolute left-0 top-[70%] -translate-y-1/2 "
          src={decorLeaf1.src}
          alt=""
        /> */}
      </div>
