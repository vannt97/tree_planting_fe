...
function CertificateComponent(props: CertificateComp) {
  ...
  return (
    <>
      <div
        ref={domEl}
        className={`certificateComponent text-size-adjust ${
      ...
      >
        ...
        ></div>
        <div className="certificateComponent__content p-2 laptop:p-3 text-size-adjust">
          <div className="h-full w-full flex flex-col text-size-adjust">
            <div className="flex justify-center text-size-adjust mb-2">
            ...
            <div className="flex text-size-adjust flex-1 w-full relative justify-between">
              ...
              >
                <div>
                  ...
                  <h1 className="color-primary my-1 f-oswald font-bold color-text-4b text-center certificateComponent__name text-size-adjust laptop:text-[1.8rem] tablet:text-[1.3rem] mobile:text-[1rem] tracking-wide">
                    {router?.query?.name
